...
## Material
  ...
  * Composto por 1207 crianças com idades entre 6 e 48 anos.
  * Tempo, em dias, após a aplicação da primeira dose de vitamina A até o primeiro episódio de diarréia
...
## Objetivos Específicos
  ...
  * Aplicar mátodos para verificar a relação entre a variável tempo e as covariáveis no banco
  * Propor um modelo de regressão para dados grupados
